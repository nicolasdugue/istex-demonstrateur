...
module.exports={
	...
	chart : function(var_data,var_width, var_height, var_start_year, var_end_year,var_margin, res) {
		jsdom.env(
				dataviz,
				function(errors, window) {
					var margin = {top: var_margin*2, right: var_margin*12, bottom: var_margin, left: var_margin},
						width = var_width,
						height = var_height;

					var start_year = var_start_year,
					...
					for (var j = 0; j < data.length; j++) {
						...
						var rScale = d3.scale.linear()
							.domain([0, d3.max(data[j]['frequency'], function(d) { return d[1]; })])
							.range([1, 30]);
