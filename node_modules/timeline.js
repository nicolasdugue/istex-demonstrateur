...
module.exports={
	...
	chart : function(resultats, periods, var_width, var_height, var_max, var_margin, res) {
		jsdom.env(
				dataviz,
				function(errors, window) {
					...
					var var_data=resultats.data_timeline;
					...
					resultats.svgsrc = window.document.querySelector('#dataviz-container').innerHTML;
						controller.timeline(res, resultats);
			}
		)
	}
}
