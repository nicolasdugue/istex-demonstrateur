...
module.exports={
    chart: function(dataset, width, height,paddingTop, paddingTopLegend, res){
	    jsdom.env(
			dataviz,
			function(errors, window) {
				...
				controller.barchart(res, svgsrc);
			}
		)
	}
}	
