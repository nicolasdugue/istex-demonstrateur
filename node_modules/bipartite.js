...
module.exports={
    chart: function(clustersSrc,clustersTarget, clustersAppeared, clustersVanished, width, height,margin,padding, res){
        jsdom.env(
            	dataviz,
            	function(errors, window) {
                    ...
                    var Line = function(x1,y1, srcName,x2,y2,targetName,activity,kernel,color){
                        this.x1 = x1;
                        this.y1 = y1;
                        this.x2 = x2;
                        this.y2 = y2;
                    ...
                    for (i in SrcList) {
                        ...
                        for(var i=0;i < c.target.length;i++){
                            ...
                            lines.push(new Line(c.x, c.y,c.name, target.x, target.y,target.name, c.targetActivity[i], c.kernel[i], lineColor));
                        }
                    };
                    ...
                    controller.diachronie(res, svgsrc);                    
                }
            );
    }
}