	...
	chart : function(data_marimekko,var_width,var_height,var_margin,res) {
			jsdom.env(
				...
				function(errors, window) {
					...
					domain=[]
					for (i in data) domain.push(data[i].value);
					color.domain(domain);
					color.range(colorer.brewer.RdYlGn[9].reverse());
				    ...
				    markets.append("rect")
				      ...
				      .style("fill", function(d) { return color(d.value)+";stroke-width:1px;stroke:rgb(0,0,0);fill-opacity: 0.3;" });
