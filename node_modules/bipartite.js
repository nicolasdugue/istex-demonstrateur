    ...
    chart: function(objectResult,clustersSrc,clustersTarget, clustersAppeared, clustersVanished, width, height,margin,padding, res){
        jsdom.env(
            	...
            	function(errors, window) {
                    ...
                    var sizeClsSrc= ((width - 2 * margin) - (padding*(SrcList.length + clustersVanished.length))) / (SrcList.length + clustersVanished.length) + 7;
                    //logger.debug(sizeClsSrc);
                    var sizeClsTarget= ((width - 2 * margin) - (padding*(TargetList.length + clustersAppeared.length))) / (TargetList.length + clustersAppeared.length) + 7;
